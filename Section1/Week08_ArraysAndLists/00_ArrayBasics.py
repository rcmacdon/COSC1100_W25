# -------------------------------------------------------------
# Title:  Week 8 - Introduction to Arrays and Lists (Containers)
# Author: Clint MacDonald
# Date:   March 4, 2025
# Purpose: To demonstrate the basics of arrays and lists
# -------------------------------------------------------------
...
# ---------------------------------------------------
# Example
# Create and array of integers and output the elements in the array
...
orange = myArray3.pop(1)
print(orange)
print(myArray3)

lastElement = myArray3.pop()
print(lastElement)
print(myArray3)
...
print(myArray5[2:5])    # prints [3, 4, 5]      # subset
myArray6 = myArray5[:5]
print(myArray5) 
print(myArray6) 
print(myArray5[5:])     # prints last 5 elements [6, 7, 8, 9, 10]
